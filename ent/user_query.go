...
func (uq *UserQuery) FirstID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
...
func (uq *UserQuery) FirstIDX(ctx context.Context) sid.ID {
...
func (uq *UserQuery) OnlyID(ctx context.Context) (id sid.ID, err error) {
	var ids []sid.ID
...
func (uq *UserQuery) OnlyIDX(ctx context.Context) sid.ID {
...
func (uq *UserQuery) IDs(ctx context.Context) ([]sid.ID, error) {
	var ids []sid.ID
...
func (uq *UserQuery) IDsX(ctx context.Context) []sid.ID {
	ids, err := uq.IDs(ctx)
	if err != nil {
		panic(err)
	}
